...
public class Book implements Serializable {
    ...
    public Book(String name, String genre, ArrayList<String> authors, boolean forAdult) {
        this.name = name;
        this.genre = genre;
    ...
    public Book(String id, String name, String genre, ArrayList<String> authors, boolean forAdult) {
        this.name = name;
        this.genre = genre;
        this.authors = authors;
        this.forAdult = forAdult;
    ...
    public Book(String id, String name, String genre, ArrayList<String> authors, boolean forAdult, ArrayList<String> comments) {
        this.id = id;
        this.name = name;
        this.genre = genre;
        this.authors = authors;
